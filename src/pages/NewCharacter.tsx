...
//       ...prevCharacter,
//       [name]: name in prevCharacter && typeof prevCharacter[name as keyof typeof prevCharacter] === "number"
//         ? Number(value) || 1 // Ensure numerical values stay numbers
//         : value,
//     }));
//   };
...
//   const handleCreate = () => {
//     // Check for empty entries
//     const isEmpty = Object.values(character).some((value) =>
